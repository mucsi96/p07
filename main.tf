...
module "setup_twingate_connector" {
  source           = "git::https://github.com/mucsi96/k8s-modules.git//modules/setup_twingate_connector?ref=v-56"
...
module "setup_twingate_access" {
  source            = "git::https://github.com/mucsi96/k8s-modules.git//modules/setup_twingate_access?ref=v-56"
  environment_name  = var.environment_name
...
module "provision_hetzner_server" {
  source = "git::https://github.com/mucsi96/k8s-modules.git//modules/provision_hetzner_server?ref=v-56"
...
module "setup_cluster" {
  source = "git::https://github.com/mucsi96/k8s-modules.git//modules/setup_cluster?ref=v-56"
...
module "create_redis_namespace" {
  source           = "git::https://github.com/mucsi96/k8s-modules.git//modules/create_app_namespace?ref=v-56"
  environment_name = var.environment_name
  k8s_namespace    = "redis"
...
module "create_redis" {
  source        = "git::https://github.com/mucsi96/k8s-modules.git//modules/setup_redis?ref=v-56"
  k8s_name      = "redis"
  k8s_namespace = module.create_redis_namespace.k8s_namespace
}

module "setup_ingress_controller" {
  source = "git::https://github.com/mucsi96/k8s-modules.git//modules/setup_ingress_controller?ref=v-56"
...
module "setup_metrics_server" {
  source                       = "git::https://github.com/mucsi96/k8s-modules.git//modules/setup_metrics_server?ref=v-56"
...
module "setup_k8s_dashboard" {
  source = "git::https://github.com/mucsi96/k8s-modules.git//modules/setup_k8s_dashboard?ref=v-56"
...
module "setup_prometheus_operator_crds" {
  source = "git::https://github.com/mucsi96/k8s-modules.git//modules/setup_prometheus_operator_crds?ref=v-56"
...
module "create_database" {
  source        = "git::https://github.com/mucsi96/k8s-modules.git//modules/create_postgres_database?ref=v-56"
  k8s_name      = "postgres1"
...
module "register_grafana_dashboard" {
  source = "git::https://github.com/mucsi96/k8s-modules.git//modules/register_webapp?ref=v-56"
...
module "setup_prometheus_operator" {
  source = "git::https://github.com/mucsi96/k8s-modules.git//modules/setup_prometheus_operator?ref=v-56"
...
module "setup_loki" {
  source = "git::https://github.com/mucsi96/k8s-modules.git//modules/setup_loki?ref=v-56"
...
module "setup_cloudbeaver" {
  source = "git::https://github.com/mucsi96/k8s-modules.git//modules/setup_cloudbeaver?ref=v-56"
...
module "setup_backup_app" {
  source                     = "git::https://github.com/mucsi96/k8s-modules.git//modules/setup_backup_app?ref=v-56"
  environment_name           = var.environment_name
...
module "setup_learn_language_app" {
  source                     = "git::https://github.com/mucsi96/k8s-modules.git//modules/setup_learn_language_app?ref=v-56"
  environment_name           = var.environment_name
  azure_location             = var.azure_location
  owner                      = local.owner
  k8s_host                   = module.setup_cluster.k8s_host
...
module "setup_hello_app" {
  source                     = "git::https://github.com/mucsi96/k8s-modules.git//modules/setup_hello_app?ref=v-56"
  environment_name           = var.environment_name
  azure_location             = var.azure_location
  owner                      = local.owner
  k8s_host                   = module.setup_cluster.k8s_host
...
module "setup_training_log_app" {
  source                     = "git::https://github.com/mucsi96/k8s-modules.git//modules/setup_training_log_app?ref=v-56"
  environment_name           = var.environment_name
  azure_location             = var.azure_location
  owner                      = local.owner
  k8s_host                   = module.setup_cluster.k8s_host
...
module "setup_bank_email_worker" {
  source = "git::https://github.com/mucsi96/k8s-modules.git//modules/setup_bank_email_worker?ref=v-56"
...
module "setup_expense_tracker_app" {
  source = "git::https://github.com/mucsi96/k8s-modules.git//modules/setup_expense_tracker_app?ref=v-56"
...
module "setup_library_app" {
  source = "git::https://github.com/mucsi96/k8s-modules.git//modules/setup_library_app?ref=v-56"
...
module "setup_cooking_app" {
  source = "git::https://github.com/mucsi96/k8s-modules.git//modules/setup_cooking_app?ref=v-56"
...
#   source                     = "git::https://github.com/mucsi96/k8s-modules.git//modules/setup_party_app?ref=v-56"
#   environment_name           = var.environment_name
#   azure_location             = var.azure_location
#   owner                      = local.owner
#   k8s_host                   = module.setup_cluster.k8s_host
